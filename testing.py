...
subject_label = tk.Label(frame, text="Subject")
subject_entry = tk.Entry(frame)

course_label = tk.Label(frame, text="Course")
course_entry = tk.Entry(frame)

program_label = tk.Label(frame, text="Program")
program_entry = tk.Entry(frame)
...
level_combo.bind("<<ComboboxSelected>>", update_fields)
